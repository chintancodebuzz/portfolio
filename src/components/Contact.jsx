    ...
    >
      <div className="">
        ...
        <div className="px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 2xl:px-24">
          ...
          {/* Trust Badges */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 sm:gap-8 md:gap-10 lg:gap-12 text-xs sm:text-sm md:text-base text-gray-600">
            <div className="flex items-center gap-2 sm:gap-3">
              <img
                src="/src/assets/images/contact/star.svg"
                alt="rating"
                className="w-5 h-5 sm:w-6 sm:h-6 object-contain"
              />
              <span>
                <strong className="text-gray-900">4.9/5</strong> Average Ratings
              </span>
            </div>

            <div className="flex items-center gap-2 sm:gap-3">
              <img
                src="/src/assets/images/contact/award.svg"
                alt="awards"
                className="w-5 h-5 sm:w-6 sm:h-6 object-contain"
              />
              <span>
                <strong className="text-gray-900">25+</strong> Winning Awards
              </span>
            </div>

            <div className="flex items-center gap-2 sm:gap-3">
              <img
                src="/src/assets/images/contact/shield.svg"
                alt="certified"
                className="w-5 h-5 sm:w-6 sm:h-6 object-contain"
              />
              <span>
