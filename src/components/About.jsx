        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg md:text-[18px] lg:text-[20px]">
              ...
              personal touch to your product and make sure it’s eye-catching and
              easy to use. My aim is to bring across your message and identity
              in the most creative way. I’ve created web designs for many famous
              brand companies.
            </p>
          </div>
          ...
          >
            <div className="bg-white/5 backdrop-blur-xl rounded-xl p-6 sm:p-8 md:p-10 border border-white/10 hover:border-blue-500/30 transition-all duration-300 shadow-2xl">
              <p className="text-gray-300 leading-relaxed mb-6 text-base sm:text-lg md:text-[18px]">
              ...
              <div className="space-y-4">
                <p className="text-gray-300 leading-relaxed text-base sm:text-lg md:text-[18px]">
                  ...
                  companies and brands all across the world and India! So, if
                  you’d like to know more about me, I’d be happy to have a chat
                  with you. 🎉
                </p>

                <p className="text-gray-300 leading-relaxed text-base sm:text-lg md:text-[18px]">
                  Feel free to reach out and I would love to make your vision
                  come to life.
                </p>
              </div>
            </div>
